...
export function setClientCookie(key: string, value: string, days = 7) {
  ...
  // biome-ignore lint/suspicious/noDocumentCookie: Standard client-side cookie setter
...
export function deleteClientCookie(key: string) {
  // biome-ignore lint/suspicious/noDocumentCookie: Standard client-side cookie deleter
