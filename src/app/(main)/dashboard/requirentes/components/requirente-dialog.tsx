...
import { type RequirenteFormValues, requirenteFormSchema } from "../schemas/requirente-form.schema";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          <DialogTitle>{isEditing ? "Editar Unidad Requirente" : "Crear Nueva Unidad Requirente"}</DialogTitle>
          <DialogDescription>
            {isEditing
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>Activar o desactivar esta unidad requirente</FormDescription>
                  </div>
                  <FormControl>
