...
export function DeleteSubvencionDialog({ subvencion, open, onOpenChange, onSuccess }: DeleteSubvencionDialogProps) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Estás a punto de eliminar la subvención <strong>{subvencion.nombre}</strong>. Esta acción no se puede
            deshacer.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
