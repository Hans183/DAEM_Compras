...
export function CancelCompraDialog({ compra, open, onOpenChange, onSuccess, currentUser }: CancelCompraDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Esta acción es irreversible. Una vez anulada, la compra no podrá ser modificada. Por favor, ingrese un
