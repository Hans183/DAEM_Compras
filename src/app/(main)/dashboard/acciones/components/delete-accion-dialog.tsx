...
export function DeleteAccionDialog({ open, onOpenChange, onSuccess, accion }: DeleteAccionDialogProps) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Esta acción no se puede deshacer. Esto eliminará permanentemente la acción "{accion?.nombre}".
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
