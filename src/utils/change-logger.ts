import type { Compra, CompraFormData } from "@/types/compra";
import type { CambiosObj } from "@/types/historial";

export function detectarCambios(compraOriginal: Compra, nuevosDatos: Partial<CompraFormData>): CambiosObj {
