      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Se te ha asignado una nueva solicitud de compra para gestión. Por favor revisa los detalles a
              continuación.
            </Text>
            ...
            <Text style={paragraph}>Si tienes dudas, contacta al administrador del sistema.</Text>
          </Section>

          <Section style={footer}>
            <Text style={footerText}>© {new Date().getFullYear()} DAEM La Unión. Todos los derechos reservados.</Text>
